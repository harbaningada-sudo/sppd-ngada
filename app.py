...
<style>
    ...
    .kertas-belakang { margin-top: 45mm !important; }
    ...
    .isi-surat td, .isi-surat p, .isi-surat tr { line-height: 1.5 !important; }
    ...
    .visum-table td { border: none !important; padding: 0 !important; font-size: 9.2pt; color: black !important; vertical-align: top; }
    ...
    @media print {
        ...
        .kertas-belakang { margin-top: 40mm !important; } /* Menurunkan cetakan halaman belakang */
...
for p in daftar:
    ...
    if "SPD Belakang" in opsi_cetak:
        ...
        def row_v(num, label, val, date_v, show_num=True):
            ...
            return f'''<table class="visum-table"><tr>{n}<td width="35%">{label}</td><td width="4%">:</td><td>{val}</td></tr><tr>{"<td></td>" if show_num else ""}<td>Pada Tanggal</td><td>:</td><td>{date_v}</td></tr></table>'''

        html_out += f'''<div class="kertas kertas-belakang"><table class="tabel-border">
            <tr style="height: 180px;"><td width="50%"></td><td style="padding:5px;">{row_v("I.", "Berangkat dari", "Bajawa", tgl_berangkat)}<table class="visum-table"><tr><td width="10%"></td><td width="35%">Ke</td><td width="4%">:</td><td>{tujuan}</td></tr></table>{ttd_v}</td></tr>
            <tr style="height: 155px;"><td>{row_v("II.", "Tiba di", tujuan, tgl_berangkat)}</td><td style="padding:5px;">{row_v("", "Berangkat dari", tujuan, tgl_kembali, False)}<table class="visum-table"><tr><td width="35%">Ke</td><td width="4%">:</td><td>Bajawa</td></tr></table></td></tr>
