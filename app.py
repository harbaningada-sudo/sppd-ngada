...
if tab_menu == "Input & Cetak":
    ...
    if "SPD Belakang" in opsi_cetak:
        ttd_bk_html = f'''<div style="text-align:center; line-height:1.2; font-size:10pt; margin-top:5px;"><b>An. BUPATI NGADA</b><br>{jab_ttd},<div style="height:65px;"></div><b><u>{pjb}</u></b><br>{gol_pjb}<br>NIP. {nip_ttd}</div>'''
        ...
        kiri_ii = rv("II.", "Tiba di", tujuan, tgl_bkt) if wilayah == "Dalam Daerah" else f'<table class="visum-table"><tr><td width="10%">II.</td><td width="35%">Tiba di</td><td width="5%">:</td><td>{tujuan}</td></tr></table>'
        html_out += f'''<div class="kertas"><table class="tabel-border" style="height:82%;">
            ...
            <tr style="height: 160px;"><td>{kiri_ii}</td><td style="padding:10px;">{rv("", "Berangkat dari", tujuan, tgl_kbl, False)}<table class="visum-table"><tr><td width="35%">Ke</td><td width="5%">:</td><td>Bajawa</td></tr></table></td></tr>
        ...
        <div style="border:1pt solid black; border-top:none; padding:8px; font-size:8.3pt; text-align:justify; color:black; line-height:1.2;"><b>VII. Perhatian :</b><br>Pejabat yang menerbitkan SPD... bertanggung jawab...</div></div>'''
