...
<style>
    ...
    /* KOP SURAT (Line Spacing 1.0 Rapat Sempurna) */
    ...
    /* TABEL KHUSUS VISUM UNTUK LURUSKAN TITIK DUA */
    .inner-table { width: 100%; border: none !important; }
    .inner-table td { border: none !important; padding: 0 !important; line-height: 1.2; font-size: 9.5pt; }
...
for p in daftar:
    ...
    # 3. HALAMAN SPD BELAKANG (TITIK DUA LURUS)
