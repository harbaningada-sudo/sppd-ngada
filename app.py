...
<style>
    ...
    @media print {
        ...
        .kertas-belakang { margin-top: 50mm !important; }
...
with st.sidebar:
    ...
    ub_ttd = st.text_input("Ub. (Jika ada)", "Asisten Perekonomian dan Pembangunan")
...
# 2. CETAK SPD DEPAN & BELAKANG (Dinamis per Pegawai)
for p in daftar:
    ...
    if "SPD Belakang" in opsi_cetak:
        ...
        html_out += f'''<div class="kertas kertas-belakang"><table class="tabel-border">
            <tr style="height: 180px;"><td width="50%"></td><td style="padding:5px;">{rv("I.", "Berangkat dari", "Bajawa", tgl_berangkat)}<table class="visum-table"><tr><td width="10%"></td><td width="35%">Ke</td><td width="3%">:</td><td>{tujuan}</td></tr></table>{ttd_global}</td></tr>
            <tr style="height: 155px;"><td>{rv("II.", "Tiba di", tujuan, tgl_berangkat)}</td><td style="padding:5px;">{rv("", "Berangkat dari", tujuan, tgl_kembali, False)}<table class="visum-table"><tr><td width="35%">Ke</td><td width="3%">:</td><td>Bajawa</td></tr></table></td></tr>
            ...
            <tr style="height: 180px;"><td>{rv("V.", "Tiba Kembali", "Bajawa", tgl_kembali)}</td><td style="padding:5px;"><p style="font-style:italic; font-size:8.8pt; line-height:1.2; margin-top:2px;">Telah diperiksa, dengan keterangan bahwa perjalanan tersebut atas perintahnya dan semata-mata untuk kepentingan jabatan</p>{ttd_global}</td></tr>
