...
<style>
    ...
    .kop-teks { text-align: center; line-height: 1.2; }
...
# KOP LOGIC
kop_pemda = f'''<table class="kop-table"><tr><td width="15%"><img src="data:image/png;base64,{LOGO_PEMDA}" width="80"></td><td class="kop-teks"><h3>PEMERINTAH KABUPATEN NGADA</h3><h2>SEKRETARIAT DAERAH</h2><p>Jln. Soekarno - Hatta No. 1 Telp (0384) 21012</p><p class="text-bold">BAJAWA</p></td><td width="15%"></td></tr></table>'''
kop_garuda = f'''<div class="text-center" style="margin-bottom:10px;"><img src="data:image/png;base64,{LOGO_GARUDA}" width="90"><br></div>'''
...
for i, p in enumerate(daftar):
    peg_rows += f'''
    <tr><td width="12%">Kepada</td><td width="3%">:</td><td width="4%">{i+1}.</td><td width="15%">Nama</td><td width="2%">:</td><td><b>{p['nama']}</b></td></tr>
    <tr><td></td><td></td><td></td><td>Pangkat/Gol</td><td>:</td><td>{p['gol']}</td></tr>
    <tr><td></td><td></td><td></td><td>NIP</td><td>:</td><td>{p['nip']}</td></tr>
    <tr><td></td><td></td><td></td><td>Jabatan</td><td>:</td><td>{p['jab']}</td></tr>
    '''

html_content += f'''
<div class="kertas">
    {s_kop}
    <div class="text-center"><h3 class="text-bold underline">SURAT PERINTAH TUGAS</h3><p>NOMOR : {no_spt}</p></div>
    <table class="tabel-polos" style="margin-top:20px;"><tr><td width="12%">Dasar</td><td width="3%">:</td><td>{anggaran}</td></tr></table>
    <p class="text-center text-bold" style="margin:20px 0;">M E M E R I N T A H K A N</p>
    <table class="tabel-polos">{peg_rows}</table>
    <table class="tabel-polos" style="margin-top:20px;"><tr><td width="12%">Untuk</td><td width="3%">:</td><td>{maksud}</td></tr></table>
    <div style="margin-left:55%; margin-top:30px;">
        ...
        <div style="line-height:1.2;"><b>An. BUPATI NGADA</b><br>{jab_ttd},<br><br><br><br><b><u>{pjb}</u></b><br>NIP. {nip_ttd}</div>
    </div>
</div>'''

# 2. SPD DEPAN (Gambar 2)
for p in daftar:
    html_content += f'''
    <div class="kertas">
        {kop_pemda}
        <div style="margin-left:60%; font-size:10.5pt; line-height:1.2;">
            Lembar ke &nbsp;&nbsp;: {p["lembar"]}<br>Kode No &nbsp;&nbsp;&nbsp;&nbsp;: {kode_no_spd}<br>Nomor &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {p["spd"]}
        </div>
        <h3 class="text-center text-bold underline" style="margin:10px 0 0 0;">SURAT PERJALANAN DINAS</h3>
        <h3 class="text-center text-bold" style="margin-bottom:10px;">(SPD)</h3>
        <table class="tabel-border">
            <tr><td width="4%">1.</td><td width="42%">Pejabat yang memberi perintah</td><td colspan="3"><b>BUPATI NGADA</b></td></tr>
            <tr><td>2.</td><td>Nama Pegawai yang diperintah</td><td colspan="3"><b>{p['nama']}</b></td></tr>
            ...
            <tr><td>a. Tanggal Berangkat</td><td colspan="3">11 Februari 2026</td></tr>
            <tr><td>b. Tanggal Harus Kembali</td><td colspan="3">11 Februari 2026</td></tr>
            <tr><td>8.</td><td>Pengikut &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Nama</td><td class="text-center" width="20%">Tanggal Lahir</td><td colspan="2" class="text-center">Keterangan</td></tr>
        ...
        <div style="margin-left:55%; margin-top:15px; font-size:11pt; line-height:1.2;">
            <table class="tabel-polos">
                <tr><td width="40%">Dikeluarkan di</td><td width="5%">:</td><td>Bajawa</td></tr>
                <tr><td>Pada Tanggal</td><td>:</td><td>11 Februari 2026</td></tr>
            </table><br>
            <b>An. BUPATI NGADA</b><br>Sekretaris Daerah,<br>Ub. Asisten Pemerintahan dan Kesra<br><br><br><br><b><u>Alfian, S.Sos</u></b><br>NIP. 19710913 199403 1 008
        </div>
    </div>'''

    # 3. SPD BELAKANG (Gambar 3)
    ...
    <div class="kertas">
        <table class="tabel-border">
            <tr style="height: 180px;"><td width="50%"></td><td style="padding-top:10px;">I. &nbsp; Berangkat dari : Bajawa<br>&nbsp;&nbsp;&nbsp;Ke : Kec. Golewa<br>&nbsp;&nbsp;&nbsp;Pada Tanggal : 25 Februari 2026<br>{ttd_v}</td></tr>
            <tr style="height: 160px;"><td>II. &nbsp; Tiba di : Kec. Jerebuu<br>&nbsp;&nbsp;&nbsp;&nbsp;Pada Tanggal : 13 Februari 2026</td><td>&nbsp;&nbsp;&nbsp;&nbsp;Berangkat dari : Kec. Jerebuu<br>&nbsp;&nbsp;&nbsp;&nbsp;Ke : Kec. Bajawa<br>&nbsp;&nbsp;&nbsp;&nbsp;Pada Tanggal : 14 Februari 2026</td></tr>
            <tr style="height: 155px;"><td>III. &nbsp; Tiba di : <br>&nbsp;&nbsp;&nbsp;&nbsp;Pada Tanggal : </td><td>&nbsp;&nbsp;&nbsp;&nbsp;Berangkat dari : <br>&nbsp;&nbsp;&nbsp;&nbsp;Ke : <br>&nbsp;&nbsp;&nbsp;&nbsp;Pada Tanggal : </td></tr>
            <tr style="height: 180px;"><td>V. &nbsp; Tiba Kembali : Bajawa<br>&nbsp;&nbsp;&nbsp;&nbsp;Pada Tanggal : 14 Februari 2026</td><td><p style="font-style:italic; font-size:9.5pt; line-height:1.2; margin-bottom:10px;">Telah diperiksa, dengan keterangan bahwa perjalanan tersebut atas perintahnya dan semata-mata untuk kepentingan jabatan</p>{ttd_v}</td></tr>
        </table>
        <div style="border:1pt solid black; border-top:none; padding:8px; font-size:10.5pt;"><b>VI. Catatan Lain-lain</b></div>
        <div style="border:1pt solid black; border-top:none; padding:8px; font-size:9pt; text-align:justify; line-height:1.3;">
