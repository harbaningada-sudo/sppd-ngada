...
<div class="text-center" style="margin-bottom:10px;">
    <img src="data:image/png;base64,{logo.GARUDA}" width="85"><br>
...
for i, p in enumerate(daftar):
    peg_rows += f'''
    <tr><td width="12%">Kepada</td><td width="2%">:</td><td width="4%">{i+1}.</td><td width="15%">Nama</td><td width="2%">:</td><td><b>{p['nama']}</b></td></tr>
...
<div class="kertas">
    ...
    <table class="tabel-polos" style="margin-top:15px;"><tr><td width="12%">Untuk</td><td width="2%">:</td><td>{maksud}</td></tr></table>
    <div style="margin-left:55%; margin-top:20px; line-height:1.2;">
        ...
        <div style="line-height:1.2;"><b>An. BUPATI NGADA</b><br>{jab_ttd},<br><br><br><br><b><u>{pjb}</u></b><br>{gol_pjb}<br>NIP. {nip_ttd}</div>
    </div>
</div>'''

# 2. HALAMAN SPD DEPAN (SESUAI GAMBAR 2)
for p in daftar:
    html_out += f'''
    <div class="kertas">
        {kop_pemda}
        ...
        <div style="margin-left:55%; margin-top:15px; font-size:10.5pt; line-height:1.2;">
            <table class="tabel-polos">
                <tr><td width="40%">Dikeluarkan di</td><td>: Bajawa</td></tr>
                <tr><td>Pada Tanggal</td><td>: 11 Februari 2026</td></tr>
            </table><br>
            <b>An. BUPATI NGADA</b><br>Sekretaris Daerah,<br>Ub. Asisten Pemerintahan dan Kesra<br><br><br><b><u>Alfian, S.Sos</u></b><br>Pembina Utama Muda - IV/c<br>NIP. 19710913 199403 1 008
        </div>
    </div>'''

    # 3. HALAMAN SPD BELAKANG (SESUAI GAMBAR 3)
    ttd_v = f'''<div style="text-align:center; line-height:1.1; font-size:10pt;"><b>An. Bupati Ngada</b><br>{jab_ttd},<br><br><br><b><u>{pjb}</u></b><br>{gol_pjb}<br>NIP. {nip_ttd}</div>'''
    html_out += f'''
    <div class="kertas">
        <table class="tabel-border">
            ...
            <tr style="height: 180px;"><td>V. &nbsp; Tiba Kembali : Bajawa<br>&nbsp;&nbsp;&nbsp;&nbsp;Pada Tanggal : 14 Februari 2026</td><td><p style="font-style:italic; font-size:9pt; line-height:1.2; margin-bottom:10px;">Telah diperiksa, dengan keterangan bahwa perjalanan tersebut atas perintahnya dan semata-mata untuk kepentingan jabatan</p>{ttd_v}</td></tr>
        </table>
        <div style="border:1pt solid black; border-top:none; padding:8px; font-size:10pt;"><b>VI. Catatan Lain-lain</b></div>
        <div style="border:1pt solid black; border-top:none; padding:8px; font-size:8.5pt; text-align:justify; line-height:1.2;">
