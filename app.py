...
<style>
    ...
    /* TABEL TRANSPARAN UNTUK LURUSKAN TITIK DUA */
    .inner-table { width: 100%; border: none !important; margin: 0 !important; }
    .inner-table td { border: none !important; padding: 0 !important; font-size: 10pt; line-height: 1.2; color: black !important; }
...
# TTD Global
ttd_global = f'''<div style="margin-left:55%; margin-top:20px; line-height:1.2; color:black; font-size:10.5pt;"><table class="inner-table"><tr><td width="40%">Ditetapkan di</td><td width="5%">:</td><td>Bajawa</td></tr><tr><td>Pada Tanggal</td><td>:</td><td>{tgl_str(datetime.now())}</td></tr></table><br><b>An. BUPATI NGADA</b><br>{jab_ttd},<br><br><br><br><br><b><u>{pjb}</u></b><br>{gol_pjb}<br>NIP. {nip_ttd}</div>'''
