...
with st.sidebar:
    ...
    with st.expander("👤 DATA PEGAWAI"):
        ...
        for i in range(st.session_state.jml):
            ...
            g = st.text_input(f"Pangkat/Gol P-{i+1}", "Pembina Utama Muda - IV/c", key=f"g{i}")
...
<div style="margin-left:55%; margin-top:20px; line-height:1.2; color:black; font-size:10.5pt;">
    ...
    <b><u>{pjb}</u></b><br>NIP. {nip_p}
</div>
"""

# --- A. HALAMAN SPT (Identik Gambar 1) ---
...
# --- B. HALAMAN SPD (Identik Gambar 2 & 3) ---
for p in daftar:
    # --- DEPAN ---
