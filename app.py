...
with st.sidebar:
    ...
    if tab_menu == "Input & Cetak":
        ...
        gol_pjb = st.text_input("Pangkat", "Pembina Utama Muda - IV/c")
...
if tab_menu == "Input & Cetak":
    if "SPT" in opsi_cetak:
        ...
        html_out += f'''<div class="kertas">{kop_pemda}
            ...
            </div>{render_ttd(85)}</div>'''

    for p in daftar:
        if "SPD Depan" in opsi_cetak:
            html_out += f'''<div class="kertas">{kop_pemda}<div style="margin-left:60%; line-height:1.0;"><table class="visum-table"><tr><td width="40%">Lembar ke</td><td width="5%">:</td><td>{p["lembar"]}</td></tr><tr><td>Nomor</td><td>:</td><td>{p["spd"]}</td></tr></table></div><div class="judul-rapat"><h3 class="underline">SURAT PERJALANAN DINAS</h3><h3>(SPD)</h3></div>
    ...
    if "SPD Belakang" in opsi_cetak:
        ...
        html_out += f'''<div class="kertas"><table class="tabel-border" style="height:88%;">
            <tr style="height: 220px;"><td width="50%"></td><td style="padding:10px;"><table class="visum-table"><tr><td>I. Berangkat dari</td><td>:</td><td>Bajawa</td></tr><tr><td>Pada Tanggal</td><td>:</td><td>{tgl_bkt}</td></tr></table>{ttd_bk}</td></tr>
            <tr style="height: 190px;"><td><table class="visum-table"><tr><td>II. Tiba di</td><td>:</td><td>{tujuan}</td></tr></table></td><td style="padding:10px;"><table class="visum-table"><tr><td>Berangkat dari</td><td>:</td><td>{tujuan}</td></tr><tr><td>Ke</td><td>:</td><td>Bajawa</td></tr></table></td></tr>
            <tr style="height: 220px;"><td><table class="visum-table"><tr><td>V. Tiba Kembali</td><td>:</td><td>Bajawa</td></tr></table></td><td style="padding:10px;"><p style="font-style:italic; font-size:9pt;">Telah diperiksa...</p>{ttd_bk}</td></tr>
        </table></div>'''

html_out += '</div>'

# INI BAGIAN PALING PENTING SUPAYA KODE TIDAK TAMPIL MENTAH
