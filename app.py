...
# --- BAGIAN LOGO (PASTE KODE PANJANGMU DI DALAM KUTIP TIGA INI) ---
logo_data_url = """TEMPEL_KODE_BASE64_DI_SINI""" 

if len(logo_data_url) > 100:
    logo_html = f'<img src="{logo_data_url}" style="width: 80px; height: auto; margin-right: 20px;">'
else:
