...
<style>
    ...
    /* KHUSUS HALAMAN BELAKANG TURUN LAGI SEDIKIT */
    .kertas-belakang { margin-top: 35mm !important; }
    ...
    .tabel-border td { border: 1pt solid black !important; padding: 4px 6px !important; vertical-align: top; color: black !important; font-size: 9.5pt; }
    
    /* TABEL KHUSUS VISUM SEJAJAR */
    ...
    @media print {
        ...
        .kertas-belakang { margin-top: 30mm !important; } /* Menurunkan cetakan halaman belakang */
...
if "Register" in opsi_cetak:
    ...
    html_out += f'''<div class="kertas"><h3 class="text-center text-bold">REGISTER SURAT PERJALANAN DINAS</h3><br><table class="tabel-border"><thead><tr style="background:#eee;"><th>No</th><th>Nama Pegawai</th><th>No SPT</th><th>No SPD</th><th>Tgl Berangkat</th><th>Tujuan</th></tr></thead><tbody>{rows_reg}</tbody></table></div>'''
