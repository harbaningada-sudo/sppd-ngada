...
<style>
    ...
    /* KERTAS A4: Dipaksa Putih agar Layout Terlihat */
    .kertas { 
...
with st.sidebar:
    ...
    with st.expander("🕒 TTD"):
        ...
        pejabat = st.text_input("Nama Pejabat", "Dr. Nicolaus Noywuli, S.Pt, M.Si")
        nip_pjb = st.text_input("NIP Pejabat", "19720921 200012 1 004")
...
kop_sekda = f'<div class="kop-daerah"><img src="data:image/png;base64,{LOGO_PEMDA}"><div class="kop-teks"><h3>PEMERINTAH KABUPATEN NGADA</h3><h2>SEKRETARIAT DAERAH</h2><p>Jln. Soekarno - Hatta No. 1 Telp (0384) 2225834</p><p class="text-bold">BAJAWA</p></div></div>'
kop_bupati = f'<div class="logo-garuda-box"><img src="data:image/png;base64,{LOGO_GARUDA}"><h2 style="color:black; margin:0;">BUPATI NGADA</h2></div>'
