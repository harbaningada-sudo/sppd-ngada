...
<style>
    ...
    /* KHUSUS HALAMAN BELAKANG TURUN SEDIKIT */
    ...
    .tabel-border td { border: 1pt solid black !important; padding: 2px 4px !important; vertical-align: top; color: black !important; font-size: 9.2pt; }
    ...
    @media print {
        ...
        .kertas-belakang { margin-top: 15mm !important; } /* Menurunkan halaman belakang saat cetak */
...
for p in daftar:
    ...
    html_out += f'''<div class="kertas kertas-belakang"><table class="tabel-border">
        ...
        <tr style="height: 155px;">
            <td style="padding:5px;">{row_vis("II.", "Tiba di", tujuan, tgl_str(datetime.now()))}</td>
            <td style="padding:5px;">{row_vis("", "Berangkat dari", tujuan, tgl_str(datetime.now()), False)}<table class="visum-table"><tr><td width="40%">Ke</td><td width="5%">:</td><td>Bajawa</td></tr></table></td>
        </tr>
        <tr style="height: 150px;">
            <td style="padding:5px;">{row_vis("III.", "Tiba di", "", "")}</td>
            <td style="padding:5px;">{row_vis("", "Berangkat dari", "", "", False)}</td>
        </tr>
        <tr style="height: 150px;">
            <td style="padding:5px;">{row_vis("IV.", "Tiba di", "", "")}</td>
            <td style="padding:5px;">{row_vis("", "Berangkat dari", "", "", False)}</td>
        </tr>
