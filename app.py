...
# CSS AGRESSIVE: Memaksa warna putih pekat dan teks hitam pekat
st.markdown("""
<style>
    ...
    /* Container Kertas agar di Tengah */
    .main-container {
        display: flex;
    ...
    /* KERTAS A4: Putih Bersih, Teks Hitam, Ukuran Kunci */
    .kertas { 
        background-color: #ffffff !important; 
        width: 210mm; 
        min-height: 297mm; 
        padding: 20mm 25mm; /* Padding standar naskah dinas */
        margin-bottom: 30px;
        color: #000000 !important; 
        font-family: Arial, sans-serif; 
        box-sizing: border-box; 
        box-shadow: 0 0 20px rgba(0,0,0,1); /* Shadow lebih gelap agar batas kertas jelas */
        display: block;
    }

    /* TABEL: Kunci Garis & Lebar Kolom */
    .tabel-border { 
        width: 100%; 
    ...
    .kop-daerah { display: flex; align-items: center; border-bottom: 4px solid #000000; padding-bottom: 5px; margin-bottom: 15px; }
    ...
    @media print {
        ...
        .kertas { box-shadow: none !important; margin: 0 !important; width: 210mm !important; page-break-after: always; }
...
for p in daftar:
    ...
    <table class="tabel-border">
        ...
        <tr><td>a. Tanggal Berangkat</td><td colspan="3">17 Maret 2026</td></tr>
        <tr><td>b. Tanggal Harus Kembali</td><td colspan="3">17 Maret 2026</td></tr>
