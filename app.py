...
<style>
    ...
    .kop-teks { text-align: center; line-height: 1.0 !important; } /* Spasi Rapat 1.0 */
...
<div class="kertas">
    ...
    <table class="tabel-polos" style="margin-top:15px;"><tr><td width="12%">Untuk</td><td width="3%">:</td><td>{maksud}</td></tr></table>
    {ttd_global}
</div>'''
