...
<style>
    ...
    .tabel-polos { width: 100%; border: none !important; border-collapse: collapse; margin: 0 !important; }
    .tabel-polos td { border: none !important; padding: 0 !important; vertical-align: top; font-size: 10.5pt; line-height: 1.2; color: black !important; }
...
for p in daftar:
    ...
    <div class="kertas">
        <table class="tabel-border">
            <tr style="height: 180px;"><td width="50%"></td><td style="padding:10px;"><table class="tabel-polos">{visum_block("I.", "Berangkat dari", "Bajawa", tgl_str(datetime.now()))}<tr><td colspan="4">Ke &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {tujuan}</td></tr></table>{ttd_v}</td></tr>
            <tr style="height: 160px;"><td><table class="tabel-polos">{visum_block("II.", "Tiba di", tujuan, tgl_str(datetime.now()))}</table></td><td>&nbsp;&nbsp;&nbsp;&nbsp; <table class="tabel-polos">{visum_block("", "Berangkat dari", tujuan, tgl_str(datetime.now()))}<tr><td colspan="4">Ke &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: Bajawa</td></tr></table></td></tr>
            <tr style="height: 155px;"><td><table class="tabel-polos">{visum_block("III.", "Tiba di", "", "")}</table></td><td>&nbsp;&nbsp;&nbsp;&nbsp; <table class="tabel-polos">{visum_block("", "Berangkat dari", "", "")}</table></td></tr>
            <tr style="height: 155px;"><td><table class="tabel-polos">{visum_block("IV.", "Tiba di", "", "")}</table></td><td>&nbsp;&nbsp;&nbsp;&nbsp; <table class="tabel-polos">{visum_block("", "Berangkat dari", "", "")}</table></td></tr>
            <tr style="height: 180px;"><td><table class="tabel-polos">{visum_block("V.", "Tiba Kembali", "Bajawa", tgl_str(datetime.now()))}</table></td><td><p style="font-style:italic; font-size:9pt; margin-bottom:10px; line-height:1.2;">Telah diperiksa, dengan keterangan bahwa perjalanan tersebut atas perintahnya dan semata-mata untuk kepentingan jabatan</p>{ttd_v}</td></tr>
        </table>
