...
tgl_indo = "{0} {1} {2}".format(tgl_tetap.day, bulan_list[tgl_tetap.month-1], tgl_tetap.year)

# 3. RENDER TAMPILAN
# Saya buat template HTML murni tanpa f-string di dalamnya agar tidak error
html_template = """
<style>
...
# Proses memasukkan data ke template secara aman
