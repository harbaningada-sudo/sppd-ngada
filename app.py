...
<div class="kertas-a4">
    ...
    <table class="tabel-data">
        <tr><td width="15%">Dasar</td><td width="2%">:</td><td style="text-align: justify;">{dasar}</td></tr>
    </table>

    <p style="text-align: center; letter-spacing: 3px; margin: 15px 0; font-weight: bold;">M E M E R I N T A H K A N</p>

    <table class="tabel-data">
        <tr><td width="15%">Kepada</td><td width="5%">: 1.</td><td width="15%">Nama</td><td width="2%">:</td><td style="font-weight: bold;">{nama}</td></tr>
    ...
    <table class="tabel-data">
        <tr><td width="15%">Untuk</td><td width="2%">:</td><td style="text-align: justify;">{untuk}</td></tr>
    </table>
